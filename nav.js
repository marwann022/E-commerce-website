            ...
            <div class="flex items-center space-x-4">
              ...
              <div class="relative flex items-center gap-2">
                ${currentUser ? `
                  ...
                  <button id="nav-profile-btn" class="text-primary dark:text-primary-fixed-dim hover:opacity-80 transition-opacity duration-300 scale-100 active:scale-95 transition-transform duration-200 cursor-pointer flex items-center justify-center p-1 rounded-full bg-primary/10 border border-primary/20 hover:bg-primary/20 select-none" aria-label="User Account">
                    <i data-lucide="user" class="w-5 h-5"></i>
                  </button>
                  
                  <!-- Premium Glassmorphism Dropdown -->
                  <div id="nav-profile-dropdown" class="hidden absolute right-0 top-12 w-64 bg-white/95 dark:bg-inverse-surface/95 backdrop-blur-xl border border-outline-variant/30 rounded-3xl p-5 shadow-[0_16px_36px_rgba(0,0,0,0.1)] z-50 flex flex-col gap-4">
              ...
              <button class="text-primary dark:text-primary-fixed-dim hover:opacity-80 transition-opacity duration-300 scale-100 active:scale-95 transition-transform duration-200 cursor-pointer flex items-center justify-center" aria-label="Wishlist">
                <i data-lucide="heart" class="w-5 h-5"></i>
              </button>

              <a href="cart.html" class="text-primary dark:text-primary-fixed-dim hover:opacity-80 transition-opacity duration-300 scale-100 active:scale-95 transition-transform duration-200 cursor-pointer flex items-center justify-center" aria-label="Shopping Bag">
